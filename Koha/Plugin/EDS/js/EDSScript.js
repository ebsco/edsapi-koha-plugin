...
async function PrepareItems() {
	...
	if (EDSItems > 0) {
		$('#download_cart').prop('action', '/plugin/Koha/Plugin/EDS/opac/2011/opac-downloadcart.pl');
...
function SetEDSCartField() {
	...
	if ($('#sendbasketform')) {
		$('#sendbasketform').prop('action', '/plugin/Koha/Plugin/EDS/opac/2011/opac-sendbasket.pl');
	}
...
function sendBasket() { // override function in basket.js
	...
	var loc = "/plugin/Koha/Plugin/EDS/opac/2011/opac-sendbasket.pl?" + strCookie;
...
function downloadBasket() { // override function in basket.js
	...
	var loc = "/plugin/Koha/Plugin/EDS/opac/2011/opac-downloadcart.pl?" + strCookie;
